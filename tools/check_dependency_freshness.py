...
USER_AGENT = "claude-obsidian-fork-dependency-freshness"

# This fork overlay declares its dependencies in one place. The list stays a
# tuple so a second requirements file can be added without touching anything else.
